  ...
  return (
    <>
      ...
      <div
        ...
        } sm:hidden fixed top-16 right-0 h-[calc(100vh-4rem)] w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-40 overflow-y-auto scrollbar-hide`}
      >
